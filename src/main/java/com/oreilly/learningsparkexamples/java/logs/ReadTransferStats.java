...
public class ReadTransferStats implements Serializable {
	...
	public JavaPairDStream<Long, Integer> readStats(JavaStreamingContext jssc,
		...
		JavaPairDStream<Long, Integer> usefulInput = input
				.mapToPair(new PairFunction<Tuple2<LongWritable, IntWritable>, Long, Integer>() {
					public Tuple2<Long, Integer> call(
							Tuple2<LongWritable, IntWritable> input) {
