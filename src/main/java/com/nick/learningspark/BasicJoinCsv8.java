...
public class BasicJoinCsv8 {
	...
	public static void main(String[] args) throws Exception {
		...
		String csv1 = args[1];
		String csv2 = args[2];
		BasicJoinCsv8 jsv = new BasicJoinCsv8();
	...
	public void run(String master, String csv1, String csv2) throws Exception {
		...
		/*
		JavaPairRDD<Integer, String[]> keyedRDD1 = csvFile1
				.mapToPair(new ParseLine());

		JavaPairRDD<Integer, String[]> keyedRDD2 = csvFile1
				.mapToPair(new ParseLine());

		JavaPairRDD<Integer, Tuple2<String[], String[]>> result = keyedRDD1
				.join(keyedRDD2);
		List<Tuple2<Integer, Tuple2<String[], String[]>>> resultCollection = result
				.collect();
		*/
		
		//nick
		
		JavaPairRDD<Integer, String[]> keyedRDD1 = csvFile1.mapToPair( s -> {
		...
		JavaPairRDD<Integer, String[]> keyedRDD2 = csvFile2.mapToPair( s -> {
			CSVReader reader = new CSVReader(new StringReader(s));
			String[] elements = reader.readNext();
			Integer key = Integer.parseInt(elements[0]);
			return new Tuple2(key, elements);			
